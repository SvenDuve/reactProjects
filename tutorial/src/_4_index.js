    ...
    <section className="booklist">
      <Book title={firstBook.title} author={firstBook.author} imageSource={firstBook.booklink}>
          <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. 
              Natus dolorem ex tenetur voluptate nisi illo nesciunt ipsum, 
              totam autem cupiditate!</p>
      </Book>
...
// two possible ways
const Book = ({imageSource, title, author, children}) => {
// const Book = (props) => {
    // const {imageSource, title, author} = props;
//   console.log(props);
  return( 
  <article className="book" style={{color:'black', fontSize:'20px'}} >
